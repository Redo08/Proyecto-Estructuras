# main.py
from views.prueba_iterfaz import Interface2  # Asegúrate del nombre correcto
...
if __name__ == "__main__":
    ...
    interfaz = Interface2()  # Inicializamos la interfaz
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:  # Puedes usar otro evento o condición
                if event.key == pygame.K_SPACE and not trees_loaded: # Ejemplo: al presionar ESPACIO
                    lista_de_puntos = interfaz.points()
