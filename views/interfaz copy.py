...
class Interface2:
    def __init__(self,tree_list=None):
        ...
        self.add_button_text = self.font.render("Ingresar Lista", True, self.black)
        ...
        self.trees_section_rect = pygame.Rect(20, 150, self.screen_width // 2 - 40, 200) # Mitad izquierda
        ...
        self.first_button_text = self.font.render("Primero", True, self.black)
        self.prev_button_text = self.font.render("Anterior", True, self.black)
        self.next_button_text = self.font.render("Siguiente", True, self.black)
        self.last_button_text = self.font.render("Último", True, self.black)
